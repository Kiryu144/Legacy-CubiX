							 ...
							 enet_uint32 data )
{
	...
	for( channel = currentPeer->channels; channel < &currentPeer->channels[ channelCount ];
		 ++channel )
	{
...
void enet_host_bandwidth_throttle( ENetHost* host )
{
	enet_uint32 timeCurrent	   = enet_time_get(),
				...
				peersRemaining = ( enet_uint32 )host->connectedPeers, dataTotal = ~0,
				bandwidth = ~0, throttle = 0, bandwidthLimit = 0;
