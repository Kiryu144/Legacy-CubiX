...
template< typename T1, typename T2 >
glm::vec<3, T1, glm::defaultp > operator+( const glm::vec<3, T1, glm::defaultp >& v1, const glm::vec<3, T2, glm::defaultp > v2 )
{
	return glm::vec<3, T1, glm::defaultp >{ v1.x + v2.x, v1.y + v2.y, v1.z + v2.z };
}
