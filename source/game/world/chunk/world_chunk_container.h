...
public:
	...
	// Returns if a given chunkcolumn exists in the world. This also includes non-loaded ones.
	bool doesChunkColumnExist( const glm::ivec2& pos ) const;
	...
	// Removes all reference to a given chunkcolumn
